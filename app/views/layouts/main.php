...
require_login();
require_role(['owner', 'admin_full']); // solo Owner y Admin Full pueden usar este layout
?>
<!doctype html>
<html lang="es">
...
<head>
  ...
  <style>
    /* pequeño helper local: contenedor del nav al 90% centrado */
    .nav-width-90 {
      width: 90%;
      max-width: none;
    }
    ...
    @media (min-width: 1400px) {
      ...
      /* opcional: en pantallas gigantes limitar a 1400px para que no quede demasiado ancho */
      .nav-width-90 {
        max-width: 1400px;
      }
    }
...
<body>
  <!-- Nav con gradiente (clase navbar-gradient) y wrapper al 90% -->
  <nav class="navbar navbar-expand-lg navbar-gradient fixed-top">
    <div class="nav-width-98 d-flex align-items-center"> <!-- <-- AQUI: 90% ancho centrado -->
      ...
      <div class="d-flex align-items-center ms-auto">
        ...
        <?php if (isset($_SESSION['user_name'])): ?>
          ...
          <a href="<?= BASE_URL ?>/?url=user/index" class="btn btn-outline-light me-2 d-none d-lg-inline">Usuarios</a>
          <a href="<?= BASE_URL ?>/?url=auth/logout" class="btn btn-outline-light d-none d-lg-inline">Salir</a>

          <!-- Mobile icons -->
          <a href="<?= BASE_URL ?>/?url=user/index" class="btn btn-outline-light me-2 nav-icon-btn d-lg-none" title="Usuarios" aria-label="Usuarios">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
              <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM13 7a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" />
            </svg>
          </a>
      ...
      <div class="p-3">
        <div class="d-flex align-items-center mb-3">
          ...
          <div>
            ...
            <div class="text-muted small"><?= htmlspecialchars($_SESSION['user_role'] ?? 'Administrador') ?></div>
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/?url=branch/index"><span class="icon">🏬</span> Sucursales</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/?url=transfer/index"><span class="icon">🔁</span> Traspasos</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/?url=user/index"><span class="icon">👥</span> Usuarios</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/?url=stockmovements/index"><span class="icon">📘</span> Movimientos</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/?url=product/alerts"><span class="icon">⚠️</span> Alertas stock</a></li>
          </ul>
        </div>
        ...
        <div class="small text-muted">
          ...
          <ul style="padding-left:1rem;">
            <li class="mb-1"><small>Utiliza <em>Stock crítico</em> para ver solo los items rojo/amarillo.</small></li>
            <li><small>Desde <em>Productos</em> puedes traspasar o recepcionar rápidamente.</small></li>
          </ul>
        </div>
      </div>
    </aside>
