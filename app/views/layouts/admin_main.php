<?php
// app/views/layouts/admin_main.php
require_once dirname(__DIR__, 2) . '/bootstrap.php';
require_login();
require_role(['admin_view']); // solo Administrador (visualizador)
?>
<!doctype html>
<html lang="es">
...
<head>
    ...
    <title>Administrador - Mi Inventario</title>
...
<body>
    ...
    <?php if (is_logged_in()): ?>
        <!-- Sidebar for admin-visualizador -->
            ...
            <div class="p-3">
                ...
                <div class="mb-3">
                    ...
                    <ul class="nav flex-column gap-1">
                        <!-- ADMIN VISUALIZADOR: solo estas opciones -->
                ...
                <div class="small text-muted">
                    ...
                    <ul style="padding-left:1rem;">
                        <li class="mb-1"><small>Usa filtros en Movimientos para acotar fechas.</small></li>
                        <li><small>En Traspasos revisa el estado antes de confirmar.</small></li>
                    </ul>
                </div>
            </div>
        </aside>
